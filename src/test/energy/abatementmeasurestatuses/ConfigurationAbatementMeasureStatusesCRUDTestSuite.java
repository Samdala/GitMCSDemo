package test.energy.abatementmeasurestatuses;
...
public class ConfigurationAbatementMeasureStatusesCRUDTestSuite extends
		ConfigurationAbatementMeasureStatusesPageObject {


	@DataProvider
	public Object[][] configuration() {
		return new Object[][] {
		{"Abatement Measure Statuses", "abatement_measure_statuses_grid"}
		};
	}
	...
	public void testConfigurationTypeStatusEdit(String entity, String realId) throws IOException  {
		...
		Reporter.log("<span style='font-weight:bold;color:#000033'> "
				+ "Test: Edit Energy Configuration : c10592" + entity + " </span><br>",
				true);
...
//		expandApplication();
		...
		clickOnEnergyEntity("Abatement Measure Statuses");
...
//		{setClassValue(classValue);}
	...
	public void testOverviewDefinitionDelete(String entity, String realId) throws IllegalStateException, IOException {
		...
		Reporter.log("<span style='font-weight:bold;color:#000033'> "
				+ "Test: Delete Energy Configuration: c11094 " + entity + " </span><br>",
				true);
