...
public class SupplyPointsFormValidationTestSuite122 extends
	...
	public void testMeteringSupplyPointFormValidation() throws IOException  {
		...
		String fieldValue = McsElement.getFieldValue(driver, DIALOG_SP, "supplyPointType");
		
		clickLookup(DIALOG_SP, "supplyPointType");
		
		String lookupId = getXWindowId("Select a Supply Point Type");
		
		softAssert.assertTrue(checkDefaultField("@id", lookupId, "Reference", fieldValue), "Type field is prefilled with Type marked as Default");
