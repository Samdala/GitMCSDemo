...
public class ConfigurationCommoditiesPageObject extends AbstractMcsTestSuite{
	...
	public void setDescription(String description, String dialogId) {
		WebElement descriptionField = McsElement.getElementByPartAttributeValueAndParentElement(driver,
				"div", "@class", dialogId, 
				"input", "@name", "description", true, true);
	...
	public void setEquivalencyUOM(String eqUOM, String dialogClass){
		clickLookup(dialogClass, "nominatorUom");
		setValueGridLookupWithFilters(eqUOM, "Code");
	...
	public String getEquivalencyUOM(String dialogId) {	
			return driver
				.findElement(
						By.xpath("(//div[contains(@class,'"+dialogId+"')]//input[@name='nominatorUom']//..//input)[last()]"))
				.getAttribute("value");
	}
	
	public void setCommodityBaseUOM(String baseUOM, String dialogClass){
		clickLookup(dialogClass, "denominatorUom");
	...
	public String getCommodityBaseUOM(String dialogId) {
		return driver
				.findElement(
						By.xpath("(//div[contains(@class,'"+dialogId+"')]//input[@name='denominatorUom']//..//input)[last()]"))
				.getAttribute("value");
	}
	
	public boolean checkEqUOMFieldIsReadOnly(){	
		try {
			driver.findElement(By.xpath("//div[contains(@class, '"+DIALOG_CMDT_EQUIVALENCY+"')]//input[@name='nominatorUom']//..//input[contains(@class, 'readonly')]"));
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	public boolean checkBaseUOMFieldIsReadOnly(){	
		try {
			driver.findElement(By.xpath("//div[contains(@class, '"+DIALOG_CMDT_EQUIVALENCY+"')]//input[@name='denominatorUom']//..//input[contains(@class, 'readonly')]"));
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	public void openEquivalencyLookup() {
		clickLookup(DIALOG_CMDT_EQUIVALENCY, "nominatorUom");
		waitForExtJSAjaxComplete(20);
	}
	
	public void openCommodityBaseLookup() {
		clickLookup(DIALOG_CMDT_EQUIVALENCY, "denominatorUom");
		waitForExtJSAjaxComplete(20);
	}
	...
	/**
	 * Helper method to get Values from Equivalency Drop down
	 */
	public List<String> getEquivalencyValues(String attribute, String attributeValue){
		WebElement equivalencyDropDown = driver.findElement(By.xpath("//div[contains("+attribute+",'" + attributeValue + "')]//input[contains(@name, 'equivalencyValues')]"));
		
		equivalencyDropDown.click();
