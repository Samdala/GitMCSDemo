...
protected final String SUPPLY_POINT_GRID_CLASS = "x-tab-panel x-tab-panel-noborder";
	 ...
	 */
	public boolean verifyCommodity(){
		try{
			driver.findElement(By.xpath("//div[contains(@class, 'slnmMeterId')]//input[@name='commodity']/following-sibling::input[contains(@class, 'x-form-readonly')]"));
			return true;
		} catch(Exception e){
			e.printStackTrace();
		}
