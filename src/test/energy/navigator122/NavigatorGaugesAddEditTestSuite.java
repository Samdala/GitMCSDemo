...
public class NavigatorGaugesAddEditTestSuite extends NavigatorPageObject {
	...
	public void testMandatoryFieldsGauges() throws Exception {
		...
		setLocationValueTreeLookup(scope5);
		...
		softAssert.assertTrue(McsElement.isFieldMandatory(driver, ADD_GAUGES_FORM_CLASS, "scopeLocation"),"Element Scope has correct UI (plaint text, no asterix)");
		...
		meteringGaugesPO.clearTextField(ADD_GAUGES_WINDOW_HEADER, "scopeLocation");
		...
		meteringGaugesPO.setScope122(scope5);
	...
	public void testOptionalFieldsGauges() throws Exception {
		...
		softAssert.assertEquals(getScope(), scope5, "Scope field value after creation is correct");
	...
	public void testGaugesAddEdit() throws Exception {
		...
		String statusActive = "Active";
		String scopeObjectName = "scopeLocation";
		...
		String lastModifiedDate = getValueOfAnyColumn("@class", "x-tab-panel-body-noborder x-tab-panel-body-top", "Last Modified On");
		...
		// This feature is not present in 122
		...
		String lastModifiedDateUpdated = getValueOfAnyColumn("@class", "x-tab-panel-body-noborder x-tab-panel-body-top", "Last Modified On");
	...
	public void testCopyGaugesFunctionality() throws Exception {
		...
		String scope5 = "slnmEnrgBuilding5";
		String energyObject = "slnmEnrgBuilding6";
		...
		setLocationValueTreeLookup(energyObject);
		...
		status = Grid.isRowInGridPresentLike(driver, "Location Gauge", "@class", GAUGES_GRID_CLASS);
		...
		setValueTreeLookup(energyObject);
		...
		changeTab(panelID, "Interval Data");
		...
		meteringGaugesPO.closeUsingToolBar(CHANNEL_MEASUREMENTS_CLASS);
	...
	public void testVisibilityOfAllGaugeFields() throws Exception {
		...
		if(status) {
			...
			String createdOn = getValueOfAnyColumn("@class", "x-tab-panel-body-noborder x-tab-panel-body-top", "Created On");
			...
			softAssert.assertTrue(isPropertiesTabAvailable(CHANGE_VISIBLE_COLUMNS_CLASS), "Properties Tab is available in Change Visible Column Window");
			
			softAssert.assertTrue(isColumnsTabAvailable(CHANGE_VISIBLE_COLUMNS_CLASS), "Columns Tab is available in Change Visible Column Window");
			
			waitForExtJSAjaxComplete(10);
			
			isAuditingFieldChecked(CHANGE_VISIBLE_COLUMNS_CLASS);
			
			waitForExtJSAjaxComplete(10);
			
			softAssert.assertTrue(isAuditingColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Created By"), "Created By Column is Checked");
			
			softAssert.assertTrue(isAuditingColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Created On"), "Created On Column is Checked");
			
			softAssert.assertTrue(isAuditingColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Last Modified By"), "Last Modified By Column is Checked");
			
			softAssert.assertTrue(isAuditingColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Last Modified On"), "Last Modified On Column is Checked");
			
			waitForExtJSAjaxComplete(10);
			
			isGeneralFieldChecked(CHANGE_VISIBLE_COLUMNS_CLASS);
			
			waitForExtJSAjaxComplete(10);
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Access Instructions"), "Created By Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Class"), "Class Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Code"), "Code Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Commissioning Date"), "Commissioning Date Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Description"), "Description Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "ID"), "ID Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Manufacturer"), "Manufacturer Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Model"), "Model Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Notes"), "Notes Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Physical Location"), "Physical Location Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Reference"), "Reference Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Scope"), "Scope Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Serial Number"), "Serial Number Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Status"), "Status Column is Checked");
			
			softAssert.assertTrue(isGeneralColumnsChecked(CHANGE_VISIBLE_COLUMNS_CLASS, "col-1", "Time Zone"), "Time Zone Column is Checked");
			
			waitForExtJSAjaxComplete(10);
			
			clickButton("Save", getWindowIdByClass(CHANGE_VISIBLE_COLUMNS_CLASS));
			
			waitForExtJSAjaxComplete(10);
			
			String createdByPostTxn = getValueOfAnyColumn("@class", "x-tab-panel-body-noborder x-tab-panel-body-top", "Created By");
			
			String createdOnPostTxn = getValueOfAnyColumn("@class", "x-tab-panel-body-noborder x-tab-panel-body-top", "Created On");
			
			String lastModifiedByPostTxn = getValueOfAnyColumn("@class", "x-tab-panel-body-noborder x-tab-panel-body-top", "Last Modified By");
			
			String lastModifiedDatePostTxn = getValueOfAnyColumn("@class", "x-tab-panel-body-noborder x-tab-panel-body-top", "Last Modified On");
	...
	public void testAuditField() throws Exception {
		...
		setLocationValueTreeLookup(scope);
		...
		softAssert.assertTrue(getScope().contains(scope), "Scope is PrePopulated in Navigator -> Gauges");
	...
	public void testAutomatedCreationOfChannel() throws Exception {
		...
		Reporter.log("<span style='font-weight:bold;color:#000033'> "
				+ "Test: Navigator: Automated creation of a channel : C60447" + " </span><br>", 
				true);
		...
		softAssert.assertEquals(meteringGaugesChanelsPO.getClassGaugeChannel(), "Location Gauge", "Class is Automatically Populated and equals Location Gauges in Channel Window");
		...
		softAssert.assertEquals(meteringGaugesChanelsPO.getUnitOfMeasure(), "square meter", "Unit Of Measure is Automatically Populated and equals square meter in Channel Window");
		...
		softAssert.assertEquals(meteringGaugesChanelsPO.getFieldValue(ADD_CHANEL_GAUGES_FORM_CLASS, "entryType"), "Index Value", "Entry Type is Automatically Populated and equals Index Value in Channel Window");
	...
	public void testEditDeleteExistingChannel() throws Exception {
		...
		setLocationValueTreeLookup(scope6);
		...
		meteringGaugesPO.setScope122(scope6);
		...
		softAssert.assertEquals(meteringGaugesChnlPO.getFieldValue(ADD_CHANEL_GAUGES_FORM_CLASS, "unitOfMeasure"), "hectare", "Unit Of Measure field is filled with correct value.");
		...
		softAssert.assertEquals(meteringGaugesChnlPO.getFieldValue(ADD_CHANEL_GAUGES_FORM_CLASS, "entryType"), "Index Value", "Entry Type is Automatically Populated and equals Index Value in Channel Window");
	...
	public void testChannelsEntryMethod() throws Exception {
		...
		String chnlCalculatedEntryMethod = "Calculated";
		...
		String []entryMethod = {"Manual", "Automatic", "Calculated"};
		
		List<String> entryValues = meteringGaugesChnlPO.getEntryMethodDropDownValues("@id", gaugesChnlDialogId);

		softAssert.assertEqualsNoOrder(entryValues.toArray(), entryMethod, "Manual, automatic and Calculated are displayed as next Possible statuses");
		...
		meteringGaugesChnlPO.setChnlEntryMethod(chnlCalculatedEntryMethod);		
		...
		String []entryMethodNew = {"Manual", "Automatic", "Calculated"};
		...
		softAssert.assertEqualsNoOrder(entryValuesNew.toArray(), entryMethodNew, "Manual, automatic and Calculated are displayed as next Possible statuses");
