...
public class MeteringGaugesCopyPageObject122 extends AbstractMcsTestSuite {
	...
	protected final String building1 = "slnmEnrgBuilding3";
	protected final String building2 = "slnmEnrgBuilding4";
	...
	public void selectMultipleLocations() {
		...
		String dialogId = getXWindowId("Select Locations");
		...
		Tree.checkNodeInTreeByTextValue(driver, building1);
		Reporter.log("Select "+building1+" node", true);
		waitForExtJSAjaxComplete(20);
		clickAddToSelectionButton(dialogId);
		waitForExtJSAjaxComplete(20);
		
		Tree.checkNodeInTreeByTextValue(driver, building2);
	...
	public void clickRefreshButton() {
		McsElement.getElementByPartAttributeValueAndParentElement(driver,
				"div", "@class", GAUGE_GRID_CLASS, "button", "@class", "x-btn-text",
