...
public class GaugeChannelsFormValidationTestSuite extends
	...
	public void testGaugesChannelFormValidate() throws IOException  {
		...
		Reporter.log("<span style='font-weight:bold;color:#000033'> "
				+ "Test: Check Gauges Channel form validation: 12.2 (C35036, C35037, C35035, C35034)" + " </span><br>",
				true);
		...
		softAssert.assertEquals(getFieldValue(ADD_CHANEL_GAUGES_FORM_CLASS, "entryType"), "Index Value", "entryType field is prefilled with correct value.");
		...
		softAssert.assertTrue(Grid.isRowInGridAbsent(driver, "Meter", "@id", lookupId), "Meter parameter class is not present on parameter lookup");
		
		softAssert.assertTrue(Grid.isRowInGridAbsent(driver, "Weather", "@id", lookupId), "Weather parameter class is not present on parameter lookup");
