...
/**
 * Interface for AutoItX library.
 * 
 * Source: http://sourceforge.net/projects/jwinauto
 * @author Michael.Goodnow
 */
public interface AutoItX extends com.sun.jna.Library  {

    AutoItX INSTANCE = (AutoItX) Native.loadLibrary(AutoIt3.getAutoItLib(), AutoItX.class);
