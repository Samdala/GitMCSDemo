...
public class MeteringStatusPageObject extends SalesMeteringBasePageObject {
	...
	public void checkDefault() {
		...
		WebElement isDefaultEle = McsElement.getElementByXpath(driver, METER_STATUS_ISDEFAULT);
